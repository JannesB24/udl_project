...
class EnsembleModel(nn.Module):
    def __init__(self, num_classes, num_models=3):
        ...
        self.models = nn.ModuleList([
            Models.ResBlock(num_classes) for _ in range(num_models)
        ])
...
def compare_results(original_results, ensemble_results):
    ...
    results = {
        'Original ResBlock': original_results,
        'Ensemble ResBlock': ensemble_results
    }
    ...
    if ens_gap < orig_gap:
        ...
        print(f"Ensemble did not improve overfitting")
